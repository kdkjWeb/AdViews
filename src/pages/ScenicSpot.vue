    ...
    <div class="container">
      ...
      <div class="handle-box">
        <el-row>
          ...
          <el-col :span="6">
            <div class="addUser">
              <el-button size="mini" type="primary" class="handle-del mr10" @click="handleAddUser">新增景区</el-button>
            </div>
          </el-col>
        </el-row>
      </div>
      ...
      <div>
        <el-form ref="form" :model="form" :rules="rules" label-width="100px" size="mini">
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="景区名称" prop="userName">
                <el-input v-model="form.userName" clearable></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item label="开放时间" prop="userName">
                <el-input v-model="form.userName" clearable></el-input>
              </el-form-item>
            </el-col>
          </el-row>
